...
export const metadata: Metadata = {
  title: "Política de Privacidade — S Luxury Collection",
  description: "Como a S Luxury Collection coleta, usa e protege seus dados pessoais conforme a LGPD.",
};
      ...
      <div className="container mx-auto max-w-3xl px-4 py-16">
        ...
        >
          <Section title="1. Quem somos">
            <p>
              S Luxury Collection Comércio de Importados Ltda., inscrita sob CNPJ 00.000.000/0001-00, com sede na
              Rua das Flores, 100 — Gramado, RS — Brasil ("S Luxury Collection", "nós" ou "nossos"), é a
