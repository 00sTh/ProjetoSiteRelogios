  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundColor: "#0F2E1E", border: "1px solid rgba(201,162,39,0.15)" }}
      >
        <div className="flex items-center gap-2 mb-5">
          <CreditCard className="h-4 w-4" style={{ color: "#C9A227" }} />
        ...
        <div className="grid grid-cols-2 gap-4 mb-5">
          ...
          >
            ...
            <p className="text-xl font-bold font-serif" style={{ color: "#C9A227" }}>
          ...
          <div className="space-y-1.5">
            <div className="flex rounded-full overflow-hidden h-2" style={{ backgroundColor: "rgba(200,187,168,0.08)" }}>
              <div
                ...
                style={{ width: `${cieloPct}%`, backgroundColor: "#C9A227" }}
              />
              <div
                className="h-full transition-all"
                style={{ width: `${redePct}%`, backgroundColor: "rgba(201,162,39,0.35)" }}
              />
            </div>
