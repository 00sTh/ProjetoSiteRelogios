        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Mail className="h-3.5 w-3.5" style={{ color: "rgba(201,162,39,0.5)" }} />
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Calendar className="h-4 w-4" style={{ color: "rgba(201,162,39,0.5)" }} />
                  <span className="text-sm" style={{ color: "rgba(200,187,168,0.7)" }}>Cadastro</span>
                </div>
                <span className="text-sm font-medium" style={{ color: "#F5F0E6" }}>
                  {new Date(user.createdAt).toLocaleDateString("pt-BR")}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <ShoppingBag className="h-4 w-4" style={{ color: "rgba(201,162,39,0.5)" }} />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <DollarSign className="h-4 w-4" style={{ color: "rgba(201,162,39,0.5)" }} />
                  ...
                  {user.orders.map((order) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4" style={{ color: "#C8BBA8" }}>
