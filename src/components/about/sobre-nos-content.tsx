...
const timeline = [
  { year: "2019", event: "Fundação da S Luxury Collection com foco em relógios e acessórios importados" },
      ...
      <section className="py-24 px-4" style={{ backgroundColor: "#111111" }}>
        <div className="container mx-auto max-w-7xl">
          <SectionTitle
            ...
            subtitle="Cada decisão na S Luxury Collection é tomada com base em quatro pilares fundamentais."
            align="center"
            className="mb-16"
          />
          <motion.div
