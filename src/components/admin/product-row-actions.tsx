  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        style={{
          backgroundColor: isFeatured ? "rgba(201,201,201,0.15)" : "transparent",
          color: isFeatured ? "#C9C9C9" : "rgba(200,187,168,0.4)",
          border: `1px solid ${isFeatured ? "rgba(201,201,201,0.4)" : "rgba(200,187,168,0.15)"}`,
        }}
      >
        <Star className="h-3.5 w-3.5" fill={isFeatured ? "#C9C9C9" : "none"} />
      </button>
